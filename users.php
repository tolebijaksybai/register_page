	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
		...
		<div class="collapse navbar-collapse" id="navbarColor02">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="sessions.php">Выйти</a>
				</li>
			</ul>
		</div>
	</nav>
	...
	<main id="js-page-content" role="main" class="page-content mt-3">
		...
		<div class="row" id="js-contacts">
			...
			<?php if (is_admin($_SESSION['user'])) : ?>
				...
				<?php foreach (get_users() as $result) : ?>
						...
						<div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
							<div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
								<div class="d-flex flex-row align-items-center">
									<span class="status status-success mr-3">
										<span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $result["img_src"]; ?>'); background-size: cover;"></span>
									</span>
									<div class="info-card-text flex-1">
										...
										<span class="text-truncate text-truncate-xl"><?php echo $result["work"] ?></span>
									</div>
							...
							<div class="card-body p-0 collapse show">
								<div class="p-3">
									...
									<a href="mailto:<?php echo $result["username"] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
			...
			<?php else : ?>
				...
				<?php $result = get_user($_SESSION['user']); ?>
