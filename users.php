					...
					<div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?= $user["fullname"] ?>">
						<div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
							...
							<div class="d-flex flex-row align-items-center">
								...
								<span class="status status-<?= $set_status_array[$user['status']] ?> mr-3">
									<span class="rounded-circle profile-image d-block" style="background-image:url('<?php echo $user["img_src"]; ?>'); background-size: cover;"></span>
								</span>

								<div class="info-card-text flex-1">

									<?php if (is_admin($_SESSION['user']) || $_SESSION['user'] === $user['username']) : ?>
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="edit.php?edit=<?= $user["id"] ?>">
											<i class="fa fa-edit"></i>
											Редактировать</a>
										<a class="dropdown-item" href="security.php?security=<?= $user["id"] ?>">
											<i class="fa fa-lock"></i>
											Безопасность</a>
										<a class="dropdown-item" href="status.php?status=<?= $user["id"] ?>">
											<i class="fa fa-sun"></i>
											Установить статус</a>
										<a class="dropdown-item" href="media.php?media=<?= $user["id"] ?>">
											<i class="fa fa-camera"></i>
											Загрузить аватар
										</a>
										<a href="delate_user.php?delate_id=<?= $user['id'] ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
						...
						<div class="card-body p-0 collapse show">
							<div class="p-3">
								...
								<a href="mailto:<?php echo $user["username"] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
