							...
							<?php if (is_admin($email)) : ?>
								...
								<div class="panel-content">
									...
									<div class="form-group">
										...
										<input type="text" id="simpleinput" name="fullname" class="form-control" value="<?= $result["fullname"] ?>">
									</div>
									...
									<div class="form-group">
										...
										<input type="text" id="simpleinput" name="work" class="form-control" value="<?= $result["work"] ?>">
									</div>

									<!-- tel -->
									<div class="form-group">
										<label class="form-label" for="simpleinput">Номер телефона</label>
										<input type="text" id="simpleinput" name="phone" class="form-control" value="<?= $result["phone"] ?>">
									</div>

									<!-- address -->
									<div class="form-group">
										<label class="form-label" for="simpleinput">Адрес</label>
										<input type="text" id="simpleinput" name="address" class="form-control" value="<?= $result["address"] ?>">
									</div>
