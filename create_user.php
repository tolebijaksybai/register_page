						...
						<div class="panel-container">
							...
							<div class="panel-content">
								...
								<div class="form-group">
									...
									<input type="text" id="simpleinput" class="form-control" name="add_email">
								</div>

								<!-- password -->
								<div class="form-group">
									<label class="form-label" for="simpleinput">Пароль</label>
									<input type="password" id="simpleinput" class="form-control" name="add_password">
								</div>
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
											...
											<input type="text" class="form-control border-left-0 bg-transparent pl-0" name="link_vkontakte">
										</div>
									</div>
									<div class="col-md-4">
										<!-- telegram -->
										<div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
											...
											<input type="text" class="form-control border-left-0 bg-transparent pl-0" name="link_telegram">
										</div>
									</div>
									<div class="col-md-4">
										<!-- instagram -->
										<div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
											...
											<input type="text" class="form-control border-left-0 bg-transparent pl-0" name="link_instagram">
										</div>
									</div>
