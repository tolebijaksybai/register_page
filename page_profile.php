	...
	<main id="js-page-content" role="main" class="page-content mt-3">
		<div class="subheader">
			<h1 class="subheader-title">
				<i class='subheader-icon fal fa-user'></i> <?= $result["fullname"] ?>
			</h1>
		</div>
		<div class="row">
						...
						<div class="col-12">
							<div class="d-flex flex-column align-items-center justify-content-center p-4">
								...
								<h5 class="mb-0 fw-700 text-center mt-3">
									<?= $result["fullname"] ?>
									<small class="text-muted mb-0"><?= $result["address"] ?></small>
								</h5>
						...
						<div class="col-12">
							<div class="p-3 text-center">
								...
								<a href="mailto:oliver.kopyov@marlin.ru" class="mt-1 d-block fs-sm fw-400 text-dark">
									<i class="fas fa-mouse-pointer text-muted mr-2"></i> <?= $result["username"] ?> </a>
								<address class="fs-sm fw-400 mt-4 text-muted">
									<i class="fas fa-map-pin mr-2"></i> <?= $result["work"] ?>
								</address>
							</div>
						</div>
					</div>
